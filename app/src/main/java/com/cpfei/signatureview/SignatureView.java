...
public class SignatureView extends View {
    ...
    public SignatureView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            mMinWidth = a.getDimensionPixelSize(R.styleable.SignatureView_minWidth, Utils.dp2px(context, 3));
            mMaxWidth = a.getDimensionPixelSize(R.styleable.SignatureView_maxWidth, Utils.dp2px(context, 20));
